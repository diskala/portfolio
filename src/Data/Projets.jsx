const projetsData = [
    {
      ...
      description:" Choisissez le véhicule de vos rêves parmi les plus grandes marques dont nous disposons. Amoureux des véhicules de caractère aux prestations haut de gamme ? Alors optez pour la location d’une voiture de luxe!"
    },
    {
      id: 2,
      name: 'event',
      ...
      description:"Location salles de réunion et séminaire unique, a proximité de votre entreprise avec Des équipements et services fiables, Des milliers d'entreprises font confiance à nous pourquoi pas vous..."
    },
    {
      id: 3,
      name: 'country',
      ...
      description:"Application de recherche des pays du monde entier par mot clés "
    },
    {
      id: 4,
      name: 'biblioapp',
      ...
      description:" C'est une application de gestion une bibliothèque, va vous permet de répertorier vos livres par (Titre, auteur et nemuro de livre) et de pouvoir effectuer une recherche rapide..."
    },

    {
      ...
      description:"Exploitation d'un API pour pouvoir afficher tous les Pockemons"
    },
    {
      id: 6,
      name: 'codexpress',
    ...
    },
    {
      ...
      description:"Casa c'est un site de Location d'appartements dans toute la France."
    },
    {
      id: 8,
      name: 'designer',
      ...
      description:"Site vitrine d'un artisan spécialisé dans le design et l'architecture des espaces intérieurs pour les professionnels et particuliers."
    },
    {
      id: 9,
      name: 'devpro',
