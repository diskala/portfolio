    ...
    return(
        ...
        <main>
            <div class="image_font">
                ...
                <img className="media" src="/Media/picNave4.jpg" alt=""/>
                   ...
                   <img className="photo" src="/Media/photo_3.jpg" alt=""/>
                   </div>
            ...
            <div class="presentation" id="articl">
                <h1>HELLO!</h1>
                <hr/>
                <p>Bienvenue sur mon portfolio en ligne ! Je suis Nacime,
                 Concepteur développeur d'applications Junior et c'est ici que je vous parle de mon parcours.
                </p>
                <hr/>
                <p> Puisque je suis passionné par la programmation, j'ai suivi une
                    ...
                    projets à titre personnel j'ai élargi mes compétences en 
                    utilisant des Frameworks et des bibliothèques Javascript ( Symfony 6, ReactJs , NodeJs).
                    
                      
                </p>
                <hr/> 
                <p> Actuellement je suis à la recherche d'un poste de developpeur Full stack</p>
           </div>
             
             <div class="envloppe">
             {/* <i class="fa-solid fa-envelope"></i> */}
             <span>Mon CV</span>
             <img src="/Media/icon-cv3.png" alt=""  onClick={ouvrirPDF} />
             </div>
           <div class="qualite">
            <div class="qualite1">
